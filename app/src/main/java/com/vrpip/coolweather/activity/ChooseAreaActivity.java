package com.vrpip.coolweather.activity;
...
import com.vrpip.coolweather.db.CoolWeatherDB;
import com.vrpip.coolweather.model.City;
import com.vrpip.coolweather.model.County;
import com.vrpip.coolweather.model.Province;
...
public class ChooseAreaActivity extends Activity {
    ...
    /**
     * 破获Back按键，根据当前的级别来判断，此时应该返回市列表、省列表、还是直接退出
     * */
